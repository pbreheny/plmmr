...
#>   Cross-validation error (deviance): 1.42
#>   Scale estimate (sigma): 1.190
```
...
#> lasso-penalized model with n=197 and p=102
#> At minimum cross-validation error (lambda=0.1864):
#> -------------------------------------------------
#>   Nonzero coefficients: 3
#>   Cross-validation error (deviance): 1.36
#>   Scale estimate (sigma): 1.167
