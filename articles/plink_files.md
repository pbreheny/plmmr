...
#> Unzipped files are saved in /tmp/Rtmp5zRdVg
```
...
#> Processed files now saved as /tmp/Rtmp5zRdVg/imputed_penncath_lite.rds
```
...
#> Standardization completed at 2026-04-23 03:33:26
...
#> Calculating the eigendecomposition of K
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-23 03:33:35
#> Setting up lambda/preparing for model fitting.
#> Beginning model fitting.
#> Model fitting finished at  2026-04-23 03:33:38 
...
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-23 03:33:40
#> Beginning model fitting.
#> Model fitting finished at  2026-04-23 03:33:42 
#> Beginning eigendecomposition in fold  2 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 2
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-23 03:33:44
#> Beginning model fitting.
#> Model fitting finished at  2026-04-23 03:33:46 
#> Beginning eigendecomposition in fold  3 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 3
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-23 03:33:48
#> Beginning model fitting.
#> Model fitting finished at  2026-04-23 03:33:50 
#> Beginning eigendecomposition in fold  4 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 4
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-23 03:33:52
#> Beginning model fitting.
#> Model fitting finished at  2026-04-23 03:33:54 
#> Beginning eigendecomposition in fold  5 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 5
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-23 03:33:56
#> Beginning model fitting.
#> Model fitting finished at  2026-04-23 03:33:58
```
