...
#> Unzipped files are saved in /tmp/Rtmp73PSQC
```
...
#> Processed files now saved as /tmp/Rtmp73PSQC/imputed_penncath_lite.rds
```
...
#> Standardization completed at 2026-05-01 13:23:36
...
#> Calculating the eigendecomposition of K
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-05-01 13:23:46
#> Setting up lambda/preparing for model fitting.
#> Beginning model fitting.
#> Model fitting finished at  2026-05-01 13:23:49 
...
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-05-01 13:23:51
#> Beginning model fitting.
#> Model fitting finished at  2026-05-01 13:23:53 
#> Beginning eigendecomposition in fold  2 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 2
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-05-01 13:23:55
#> Beginning model fitting.
#> Model fitting finished at  2026-05-01 13:23:57 
#> Beginning eigendecomposition in fold  3 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 3
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-05-01 13:23:59
#> Beginning model fitting.
#> Model fitting finished at  2026-05-01 13:24:02 
#> Beginning eigendecomposition in fold  4 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 4
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-05-01 13:24:03
#> Beginning model fitting.
#> Model fitting finished at  2026-05-01 13:24:06 
#> Beginning eigendecomposition in fold  5 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 5
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-05-01 13:24:07
#> Beginning model fitting.
#> Model fitting finished at  2026-05-01 13:24:10
```
