...
#> Unzipped files are saved in /tmp/RtmpR9uZBk
```
...
#> Processed files now saved as /tmp/RtmpR9uZBk/imputed_penncath_lite.rds
```
...
#> Standardization completed at 2026-04-22 21:01:20
...
#> Calculating the eigendecomposition of K
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-22 21:01:29
#> Setting up lambda/preparing for model fitting.
#> Beginning model fitting.
#> Model fitting finished at  2026-04-22 21:01:32 
...
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-22 21:01:33
#> Beginning model fitting.
#> Model fitting finished at  2026-04-22 21:01:35 
#> Beginning eigendecomposition in fold  2 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 2
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-22 21:01:37
#> Beginning model fitting.
#> Model fitting finished at  2026-04-22 21:01:39 
#> Beginning eigendecomposition in fold  3 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 3
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-22 21:01:41
#> Beginning model fitting.
#> Model fitting finished at  2026-04-22 21:01:43 
#> Beginning eigendecomposition in fold  4 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 4
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-22 21:01:45
#> Beginning model fitting.
#> Model fitting finished at  2026-04-22 21:01:47 
#> Beginning eigendecomposition in fold  5 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 5
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-22 21:01:49
#> Beginning model fitting.
#> Model fitting finished at  2026-04-22 21:01:51
```
