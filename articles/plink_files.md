...
#> Unzipped files are saved in /tmp/RtmpdIUazl
```
...
#> Processed files now saved as /tmp/RtmpdIUazl/imputed_penncath_lite.rds
```
...
#> Standardization completed at 2026-08-13 16:24:21
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpdIUazl/std_penncath_lite.rds
...
#> Calculating the eigendecomposition of K
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-08-13 16:24:31
#> Setting up lambda/preparing for model fitting.
#> Beginning model fitting.
#> Model fitting finished at  2026-08-13 16:24:34 
...
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-08-13 16:24:35
#> Beginning model fitting.
#> Model fitting finished at  2026-08-13 16:24:37 
#> Beginning eigendecomposition in fold  2 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 2
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-08-13 16:24:39
#> Beginning model fitting.
#> Model fitting finished at  2026-08-13 16:24:41 
#> Beginning eigendecomposition in fold  3 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 3
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-08-13 16:24:43
#> Beginning model fitting.
#> Model fitting finished at  2026-08-13 16:24:45 
#> Beginning eigendecomposition in fold  4 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 4
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-08-13 16:24:47
#> Beginning model fitting.
#> Model fitting finished at  2026-08-13 16:24:49 
#> Beginning eigendecomposition in fold  5 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 5
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-08-13 16:24:51
#> Beginning model fitting.
#> Model fitting finished at  2026-08-13 16:24:53
```
