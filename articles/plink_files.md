...
#> Unzipped files are saved in /tmp/RtmpIs5h5r
```
...
#> Processed files now saved as /tmp/RtmpIs5h5r/imputed_penncath_lite.rds
```
...
#> Standardization completed at 2026-04-03 21:41:33
...
#> Calculating the eigendecomposition of K
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-03 21:41:41
#> Setting up lambda/preparing for model fitting.
#> Beginning model fitting.
#> Model fitting finished at  2026-04-03 21:41:44 
...
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-03 21:41:46
#> Beginning model fitting.
#> Model fitting finished at  2026-04-03 21:41:48 
#> Beginning eigendecomposition in fold  2 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 2
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-03 21:41:50
#> Beginning model fitting.
#> Model fitting finished at  2026-04-03 21:41:52 
#> Beginning eigendecomposition in fold  3 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 3
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-03 21:41:54
#> Beginning model fitting.
#> Model fitting finished at  2026-04-03 21:41:56 
#> Beginning eigendecomposition in fold  4 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 4
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-03 21:41:57
#> Beginning model fitting.
#> Model fitting finished at  2026-04-03 21:42:00 
#> Beginning eigendecomposition in fold  5 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 5
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-04-03 21:42:01
#> Beginning model fitting.
#> Model fitting finished at  2026-04-03 21:42:04
```
