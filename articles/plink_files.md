...
#> Unzipped files are saved in /tmp/RtmpSpvipm
```
...
#> Processed files now saved as /tmp/RtmpSpvipm/imputed_penncath_lite.rds
```
...
#> Standardization completed at 2026-06-25 23:20:01
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpSpvipm/std_penncath_lite.rds
...
#> Calculating the eigendecomposition of K
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-06-25 23:20:10
#> Setting up lambda/preparing for model fitting.
#> Beginning model fitting.
#> Model fitting finished at  2026-06-25 23:20:12 
...
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-06-25 23:20:13
#> Beginning model fitting.
#> Model fitting finished at  2026-06-25 23:20:16 
#> Beginning eigendecomposition in fold  2 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 2
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-06-25 23:20:17
#> Beginning model fitting.
#> Model fitting finished at  2026-06-25 23:20:19 
#> Beginning eigendecomposition in fold  3 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 3
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-06-25 23:20:21
#> Beginning model fitting.
#> Model fitting finished at  2026-06-25 23:20:23 
#> Beginning eigendecomposition in fold  4 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 4
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-06-25 23:20:24
#> Beginning model fitting.
#> Model fitting finished at  2026-06-25 23:20:26 
#> Beginning eigendecomposition in fold  5 :
#> Starting decomposition.
#> Calculating the eigendecomposition of K
#> ** Fitting model in fold 5
#> Beginning rotation ('preconditioning').
#> Rotation (preconditioning) finished at  2026-06-25 23:20:28
#> Beginning model fitting.
#> Model fitting finished at  2026-06-25 23:20:30
```
