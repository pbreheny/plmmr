...
#> Processed files now saved as /tmp/Rtmp4tWMb9/processed_colon2.rds
...
#> Standardization completed at 2026-06-02 18:45:02
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/Rtmp4tWMb9/std_colon2.rds
```
