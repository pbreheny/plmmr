...
#> Processed files now saved as /tmp/RtmpAmKK3D/processed_colon2.rds
...
#> Standardization completed at 2026-06-02 18:33:09
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpAmKK3D/std_colon2.rds
```
