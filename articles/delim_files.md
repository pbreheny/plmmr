...
#> Processed files now saved as /tmp/RtmpTk9Hmy/processed_colon2.rds
...
#> Standardization completed at 2026-06-02 18:26:40
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpTk9Hmy/std_colon2.rds
```
