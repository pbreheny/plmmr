...
#> Processed files now saved as /tmp/RtmpMJHoNN/processed_colon2.rds
...
#> Standardization completed at 2026-05-14 21:13:28
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpMJHoNN/std_colon2.rds
```
