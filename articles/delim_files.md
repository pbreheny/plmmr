...
#> Processed files now saved as /tmp/RtmpmacowM/processed_colon2.rds
...
#> Standardization completed at 2026-05-19 04:05:40
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpmacowM/std_colon2.rds
```
