...
#> Processed files now saved as /tmp/RtmppbluMl/processed_colon2.rds
...
#> Standardization completed at 2026-06-26 14:54:31
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmppbluMl/std_colon2.rds
```
