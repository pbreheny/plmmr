...
#> Processed files now saved as /tmp/RtmpeMy6fp/processed_colon2.rds
...
#> Standardization completed at 2026-05-18 22:18:40
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpeMy6fp/std_colon2.rds
```
