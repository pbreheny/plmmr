...
#> Processed files now saved as /tmp/RtmpTNS2bd/processed_colon2.rds
...
#> Standardization completed at 2026-06-26 14:45:14
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpTNS2bd/std_colon2.rds
```
