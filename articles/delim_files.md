...
#> Processed files now saved as /tmp/RtmpdkCHeY/processed_colon2.rds
...
#> Standardization completed at 2026-08-13 16:19:47
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpdkCHeY/std_colon2.rds
```
