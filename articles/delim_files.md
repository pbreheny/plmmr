...
#> Processed files now saved as /tmp/RtmpO46lEe/processed_colon2.rds
...
#> Standardization completed at 2026-08-13 16:24:02
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpO46lEe/std_colon2.rds
```
