...
#> Processed files now saved as /tmp/RtmplsLvWg/processed_colon2.rds
...
#> Standardization completed at 2026-06-25 12:17:52
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmplsLvWg/std_colon2.rds
```
