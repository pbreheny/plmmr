...
#> Processed files now saved as /tmp/Rtmp6TSGPQ/processed_colon2.rds
...
#> Standardization completed at 2026-06-26 18:07:51
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/Rtmp6TSGPQ/std_colon2.rds
```
