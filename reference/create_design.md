...
#> Processed files now saved as /tmp/RtmpYxMgPd/processed_colon2.rds
...
#> Standardization completed at 2026-06-26 14:44:49
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpYxMgPd/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpYxMgPd
...
#> Processed files now saved as /tmp/RtmpYxMgPd/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-06-26 14:44:53
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpYxMgPd/std_penncath_lite.rds
