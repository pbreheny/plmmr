...
#> Processed files now saved as /tmp/Rtmp7kzOVu/processed_colon2.rds
...
#> Standardization completed at 2026-04-08 21:04:00
...
#> Unzipped files are saved in /tmp/Rtmp7kzOVu
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmp7kzOVu/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-08 21:04:03
#> Done with standardization. File formatting in progress
