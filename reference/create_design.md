...
#> Standardization completed at 2026-04-08 02:52:25
...
#> Unzipped files are saved in /tmp/RtmpByrajw
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpByrajw/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-08 02:52:28
#> Done with standardization. File formatting in progress
