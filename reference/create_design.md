...
#> Processed files now saved as /tmp/Rtmp6YKkRk/processed_colon2.rds
...
#> Standardization completed at 2026-04-08 20:48:10
...
#> Unzipped files are saved in /tmp/Rtmp6YKkRk
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmp6YKkRk/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-08 20:48:14
#> Done with standardization. File formatting in progress
