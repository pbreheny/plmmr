...
#> Processed files now saved as /tmp/RtmpIHt04i/processed_colon2.rds
...
#> Standardization completed at 2026-05-14 21:12:57
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpIHt04i/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpIHt04i
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpIHt04i/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-05-14 21:13:02
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpIHt04i/std_penncath_lite.rds
