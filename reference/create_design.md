...
#> Processed files now saved as /tmp/Rtmps7DQBe/processed_colon2.rds
...
#> Standardization completed at 2026-04-17 00:20:03
...
#> Unzipped files are saved in /tmp/Rtmps7DQBe
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmps7DQBe/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-17 00:20:06
#> Done with standardization. File formatting in progress
