...
#> Processed files now saved as /tmp/Rtmp9jtXeH/processed_colon2.rds
...
#> Standardization completed at 2026-08-13 16:19:21
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/Rtmp9jtXeH/std_colon2.rds
...
#> Unzipped files are saved in /tmp/Rtmp9jtXeH
...
#> Processed files now saved as /tmp/Rtmp9jtXeH/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-08-13 16:19:26
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/Rtmp9jtXeH/std_penncath_lite.rds
