...
#> Standardization completed at 2026-06-02 18:44:35
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpQF5zaF/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpQF5zaF
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpQF5zaF/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-06-02 18:44:40
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpQF5zaF/std_penncath_lite.rds
