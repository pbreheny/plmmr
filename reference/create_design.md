...
#> Processed files now saved as /tmp/RtmpPwGXjS/processed_colon2.rds
...
#> Standardization completed at 2026-01-26 15:54:19
...
#> Unzipped files are saved in /tmp/RtmpPwGXjS 
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpPwGXjS/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-01-26 15:54:22
#> Done with standardization. File formatting in progress
