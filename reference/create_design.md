...
#> Processed files now saved as /tmp/RtmpBzhfCR/processed_colon2.rds
...
#> Standardization completed at 2026-04-20 18:38:58
...
#> Unzipped files are saved in /tmp/RtmpBzhfCR
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpBzhfCR/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-20 18:39:01
#> Done with standardization. File formatting in progress
