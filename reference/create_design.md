...
#> Processed files now saved as /tmp/RtmpLQ2YoS/processed_colon2.rds
...
#> Standardization completed at 2026-03-19 20:00:22
...
#> Unzipped files are saved in /tmp/RtmpLQ2YoS 
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpLQ2YoS/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-03-19 20:00:24
#> Done with standardization. File formatting in progress
