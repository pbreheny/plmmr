...
#> Processed files now saved as /tmp/RtmpjaDaXd/processed_colon2.rds
...
#> Standardization completed at 2026-04-08 21:24:22
...
#> Unzipped files are saved in /tmp/RtmpjaDaXd
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpjaDaXd/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-08 21:24:25
#> Done with standardization. File formatting in progress
