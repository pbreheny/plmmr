...
#> Standardization completed at 2026-04-22 21:00:34
...
#> Unzipped files are saved in /tmp/Rtmp3G9aS5
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmp3G9aS5/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-22 21:00:37
#> Done with standardization. File formatting in progress
