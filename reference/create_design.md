...
#> Processed files now saved as /tmp/RtmptInxCF/processed_colon2.rds
...
#> Standardization completed at 2026-06-25 12:17:26
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmptInxCF/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmptInxCF
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmptInxCF/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-06-25 12:17:30
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmptInxCF/std_penncath_lite.rds
