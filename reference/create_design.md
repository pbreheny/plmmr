...
#> Standardization completed at 2026-04-20 19:06:28
...
#> Unzipped files are saved in /tmp/RtmpxKqLCz
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpxKqLCz/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-20 19:06:31
#> Done with standardization. File formatting in progress
