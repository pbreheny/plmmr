...
#> Processed files now saved as /tmp/RtmpjJsJ2r/processed_colon2.rds
...
#> Standardization completed at 2026-06-02 18:32:44
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpjJsJ2r/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpjJsJ2r
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpjJsJ2r/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-06-02 18:32:48
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpjJsJ2r/std_penncath_lite.rds
