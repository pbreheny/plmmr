...
#> Standardization completed at 2026-04-08 04:34:51
...
#> Unzipped files are saved in /tmp/RtmpLOJR73
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpLOJR73/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-08 04:34:54
#> Done with standardization. File formatting in progress
