...
#> Processed files now saved as /tmp/RtmpNCzTez/processed_colon2.rds
...
#> Standardization completed at 2026-05-21 15:49:26
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpNCzTez/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpNCzTez
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpNCzTez/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-05-21 15:49:30
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpNCzTez/std_penncath_lite.rds
