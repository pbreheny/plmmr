...
#> Processed files now saved as /tmp/Rtmp9zw2Fa/processed_colon2.rds
...
#> Standardization completed at 2026-04-08 19:58:58
...
#> Unzipped files are saved in /tmp/Rtmp9zw2Fa
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmp9zw2Fa/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-08 19:59:01
#> Done with standardization. File formatting in progress
