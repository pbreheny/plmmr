...
#> Processed files now saved as /tmp/RtmpOnJEoB/processed_colon2.rds
...
#> Standardization completed at 2025-12-11 19:07:21
...
#> Unzipped files are saved in /tmp/RtmpOnJEoB 
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpOnJEoB/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2025-12-11 19:07:24
#> Done with standardization. File formatting in progress
