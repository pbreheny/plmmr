...
#> Processed files now saved as /tmp/RtmpWyGKpa/processed_colon2.rds
...
#> Standardization completed at 2026-04-10 19:33:27
...
#> Unzipped files are saved in /tmp/RtmpWyGKpa
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpWyGKpa/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-10 19:33:30
#> Done with standardization. File formatting in progress
