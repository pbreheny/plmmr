...
#> Processed files now saved as /tmp/RtmpMYfmOr/processed_colon2.rds
...
#> Standardization completed at 2026-08-13 16:23:36
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpMYfmOr/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpMYfmOr
...
#> Processed files now saved as /tmp/RtmpMYfmOr/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-08-13 16:23:41
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpMYfmOr/std_penncath_lite.rds
