...
#> Processed files now saved as /tmp/RtmpSa1mxl/processed_colon2.rds
...
#> Standardization completed at 2026-04-14 18:22:45
...
#> Unzipped files are saved in /tmp/RtmpSa1mxl
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpSa1mxl/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-14 18:22:48
#> Done with standardization. File formatting in progress
