...
#> Processed files now saved as /tmp/Rtmphav6DK/processed_colon2.rds
...
#> Standardization completed at 2026-04-02 20:57:14
...
#> Unzipped files are saved in /tmp/Rtmphav6DK 
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmphav6DK/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-02 20:57:17
#> Done with standardization. File formatting in progress
