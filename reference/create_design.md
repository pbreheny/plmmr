...
#> Processed files now saved as /tmp/RtmpjlBwJx/processed_colon2.rds
...
#> Standardization completed at 2026-04-15 20:50:52
...
#> Unzipped files are saved in /tmp/RtmpjlBwJx
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpjlBwJx/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-15 20:50:55
#> Done with standardization. File formatting in progress
