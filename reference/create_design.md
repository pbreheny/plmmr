...
#> Processed files now saved as /tmp/RtmpQXX8Ti/processed_colon2.rds
...
#> Standardization completed at 2026-04-15 22:08:47
...
#> Unzipped files are saved in /tmp/RtmpQXX8Ti
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpQXX8Ti/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-15 22:08:50
#> Done with standardization. File formatting in progress
