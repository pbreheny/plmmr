...
#> Processed files now saved as /tmp/RtmpQCurez/processed_colon2.rds
...
#> Standardization completed at 2026-05-19 04:05:11
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpQCurez/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpQCurez
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpQCurez/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-05-19 04:05:15
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpQCurez/std_penncath_lite.rds
