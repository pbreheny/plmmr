...
#> Processed files now saved as /tmp/Rtmp3rlHEq/processed_colon2.rds
...
#> Standardization completed at 2026-04-02 21:35:40
...
#> Unzipped files are saved in /tmp/Rtmp3rlHEq 
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmp3rlHEq/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-02 21:35:43
#> Done with standardization. File formatting in progress
