...
- **logfile** Optional: the name (character string) of the prefix of the
  logfile to be written in `rds_dir`. Default to NULL (no log file
  written). **Note:** do not append a `.log` to the filename; this is
  done automatically.
...
#> Processed files now saved as /tmp/RtmpMVvPxY/processed_colon2.rds
...
#> Standardization completed at 2026-06-02 18:26:15
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpMVvPxY/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpMVvPxY
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpMVvPxY/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-06-02 18:26:19
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpMVvPxY/std_penncath_lite.rds
