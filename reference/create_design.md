...
#> Processed files now saved as /tmp/RtmpLDyqla/processed_colon2.rds
...
#> Standardization completed at 2026-04-23 03:32:36
...
#> Unzipped files are saved in /tmp/RtmpLDyqla
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpLDyqla/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-23 03:32:39
#> Done with standardization. File formatting in progress
