...
#> Processed files now saved as /tmp/RtmpitQ4NY/processed_colon2.rds
...
#> Standardization completed at 2026-05-18 22:18:15
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpitQ4NY/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpitQ4NY
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpitQ4NY/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-05-18 22:18:19
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpitQ4NY/std_penncath_lite.rds
