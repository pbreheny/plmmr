...
#> Processed files now saved as /tmp/RtmpQ0kIHQ/processed_colon2.rds
...
#> Standardization completed at 2026-03-12 19:33:06
...
#> Unzipped files are saved in /tmp/RtmpQ0kIHQ 
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/RtmpQ0kIHQ/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-03-12 19:33:09
#> Done with standardization. File formatting in progress
