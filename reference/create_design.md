...
#> Processed files now saved as /tmp/RtmpP8rewo/processed_colon2.rds
...
#> Standardization completed at 2026-05-19 13:32:13
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpP8rewo/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpP8rewo
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpP8rewo/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-05-19 13:32:16
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpP8rewo/std_penncath_lite.rds
