...
#> Processed files now saved as /tmp/RtmpHT57mZ/processed_colon2.rds
...
#> Standardization completed at 2026-06-11 12:41:42
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpHT57mZ/std_colon2.rds
...
#> Unzipped files are saved in /tmp/RtmpHT57mZ
...
#> process_plink() completed.
#> Processed files now saved as /tmp/RtmpHT57mZ/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-06-11 12:41:46
#> Done with standardization. File formatting in progress...
#> create_design() completed. 
#> Processed files now saved as /tmp/RtmpHT57mZ/std_penncath_lite.rds
