...
#> Processed files now saved as /tmp/Rtmpt2UjVW/processed_colon2.rds
...
#> Standardization completed at 2026-04-15 00:45:07
...
#> Unzipped files are saved in /tmp/Rtmpt2UjVW
...
#> 
#> process_plink() completed
#> Processed files now saved as /tmp/Rtmpt2UjVW/imputed_penncath_lite.rds
...
#> Subsetting data to exclude constant features (e.g., monomorphic SNPs)
#> Column-standardizing the design matrix...
#> Standardization completed at 2026-04-15 00:45:10
#> Done with standardization. File formatting in progress
