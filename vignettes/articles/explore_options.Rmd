...
There are two options for the `type` argument in the `cv.plmm()` function: 'response' and 'blup'. The latter is an acronym stands for the Best Linear Unbiased Predictor. While the 'response' method attributes all the variation to ..., the 'blup' method .... (FILL IN). 
