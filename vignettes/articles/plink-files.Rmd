...
And we can plot the coefficient paths; note that in the graph below, the region shaded in grey corresponds to values of $\lambda$ for which the model fit is nonconvex. See `ncvreg::plot.ncvreg()` for details.
