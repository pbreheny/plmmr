...
-   $\ddot{\tilde{\mathbf{X}}} \hat{\ddot{\boldsymbol{\beta}}}$ is `linear.predictors`. Note: in words, this means the `linear.predictors` in the code are on the scale of the rotated and re-standardized data!
