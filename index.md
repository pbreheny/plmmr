...
Three small datasets ship with `plmmr`, and tutorials walking through
how to analyze these data sets are documented in the [plmmr
website](https://pbreheny.github.io/plmmr/).
...
SNPs, a full `plmmr` analysis will run in about half an hour using a
